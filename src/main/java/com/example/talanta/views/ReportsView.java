...
//        layout.add(sidebar, reportsContent);
//        add(layout);
//    }
//
//    private VerticalLayout createSidebar() {
//        // Implement your sidebar creation logic here
...
//        filterBar.setJustifyContentMode(FlexLayout.JustifyContentMode.BETWEEN);
//
//        ComboBox<String> dateRange = new ComboBox<>("Date Range");
//        dateRange.setItems("This Week", "This Month", "This Year", "Custom");
//        dateRange.setValue("This Month");
//
//        Button exportPdf = new Button("PDF", VaadinIcon.FILE_TEXT.create());
//        Button exportExcel = new Button("Excel", VaadinIcon.TABLE.create());
//        HorizontalLayout exportButtons = new HorizontalLayout(exportPdf, exportExcel);
//
//        Button scheduleBtn = new Button("Schedule", VaadinIcon.CALENDAR.create());
//        
//        filterBar.add(dateRange, exportButtons, scheduleBtn);
//        main.add(filterBar);
//
//        // Summary Cards
...
//
//        cardsLayout.add(
//            createStatCard("1,234", "Total Users", VaadinIcon.USER),
//            createStatCard("$12,340", "Total Revenue", VaadinIcon.DOLLAR),
//            createStatCard("Python 101", "Top Course", VaadinIcon.BOOK),
//            createStatCard("Data Science", "Top Career", VaadinIcon.ACADEMY_CAP)
//        );
...
//
//        VerticalLayout revenueChartBox = new VerticalLayout();
//        revenueChartBox.add(new com.vaadin.flow.component.html.H1("Revenue Over Time"));
//        revenueChartBox.add(createLineChart("Revenue", new Number[]{500, 800, 1200, 900, 1500}));
//        revenueChartBox.getStyle().set("background", "white").set("border-radius", "10px").set("padding", "15px");
//
//        VerticalLayout courseChartBox = new VerticalLayout();
//        courseChartBox.add(new com.vaadin.flow.component.html.H1("Top Courses"));
//        courseChartBox.add(createBarChart(new String[]{"Python", "Java", "UX Design", "Data Science"}, new Number[]{450, 320, 280, 400}));
//        courseChartBox.getStyle().set("background", "white").set("border-radius", "10px").set("padding", "15px");
//
//        chartsLayout.add(revenueChartBox, courseChartBox);
//        main.add(chartsLayout);
//
//        // Action Area
...
//        Button filterBtn = new Button("Filter by Course", VaadinIcon.FILTER.create());
//        
//        actionBar.add(refreshBtn, filterBtn);
//        main.add(actionBar);
//
//        return main;
//    }
...
//
//        HorizontalLayout header = new HorizontalLayout(icon.create(), new Span(label));
...
//
//        card.add(header, valueLabel);
//        return card;
//    }
//
//    private Chart createLineChart(String title, Number[] data) {
//        Chart chart = new Chart(ChartType.LINE);
//        Configuration conf = chart.getConfiguration();
//        conf.setTitle(title);
//
//        conf.getxAxis().setCategories("Jan", "Feb", "Mar", "Apr", "May");
...
//    }
//
//    private Chart createBarChart(String[] categories, Number[] data) {
//        Chart chart = new Chart(ChartType.BAR);
//        Configuration conf = chart.getConfiguration();
//        conf.setTitle("");
//
//        conf.getxAxis().setCategories(categories);
//        DataSeries series = new DataSeries("Views");
//        series.setData(data);
//        conf.addSeries(series);
//
//        chart.setWidthFull();
