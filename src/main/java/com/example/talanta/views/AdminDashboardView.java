...
public class AdminDashboardView extends VerticalLayout {
    ...
    private VerticalLayout createMainContent() {
        ...
        VerticalLayout headingDateLayout = new VerticalLayout();
        H1 heading = new H1("Welcome, Admin");
        heading.getStyle()
            .set("color", "#E65100")
            .set("margin", "0");
        Paragraph date = new Paragraph("Tuesday, April 8, 2025");
    ...
    private VerticalLayout createBoxWithChartJsGraph() {
        VerticalLayout box = new VerticalLayout();
        box.getStyle()
           .set("background-color", "white")
           .set("padding", "20px")
        ...
        UI.getCurrent().getPage().executeJs(chartJs);
    ...
    private VerticalLayout createActivityBox() {
        ...
        H1 title = new H1("Recent Activity");
        title.getStyle()
            .set("margin", "0 0 15px 0")
            .set("color", "#333333")
            .set("font-size", "18px");
